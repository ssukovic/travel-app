...
const bull = (
  ...
  export const PostList = () => { 
    return (
      ...
      <Link to="/detailed-post-view"><Card sx={{ minWidth: 275, marginRight: 5 }}>
      ...
      <Button variant="outlined" style={{maxHeight: 40, justifyContent: "center"}}>Create a new post</Button>
    </div>
  );
  };
