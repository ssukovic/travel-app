...
export default function MostAskedQuestions() {
  const questions = [
      ...
      replies: [
        {
          id: 1,
          user: { name: "Sale S." },
          text: "The British Museum is a public museum dedicated to human history, art and culture located in the Bloomsbury area of London!",
        },
        {
          id: 1,
          user: { name: "Adriana M." },
          text: "Have fun! London is awesome.",
        },
    ...
    {
      id: 1,
      user: { name: "Anja S.", userPic: "https://i.pravatar.cc/150?img=1" },
    ...
    },
    {
      ...
      replies: [{ id: 1, user: { name: "Sale S." }, text: "Have fun!" }],
    },
  ];
