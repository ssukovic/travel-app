...
export default function MostAskedQuestions() {
    ...
    return (
        <Grid container>
            <Grid item xs={9}>
                <Typography sx={{ fontWeight: 'light' }} align="left" variant="h3" component="h3">Most asked question</Typography>
            </Grid>
            <Grid item xs={3}>
                <CardActions sx={{ justifyContent: "center" }}>
                    <Button onClick={handleSearch} fullWidth size="large" variant="outlined">Ask a question</Button>
                </CardActions>
